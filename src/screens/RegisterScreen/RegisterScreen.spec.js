...
describe("RegisterScreen component", () => {
  ...
  describe('Name field', () => {
    ...
    it('should show max length error when it has more than 45 characters', async () => {
      ...
      await waitFor(() => fireEvent.changeText(
        nameInput, 'Este texto deve ter mais de quarenta e cinco caracteres'));
  ...
  describe('Username field', () => {
    ...
    it('should show max length error when it has more than 45 characters', async () => {
      ...
      await waitFor(() => fireEvent.changeText(
        usernameInput, 'usuarioextremamentemuitograndemesmogigantemente'));
      await waitFor(() => fireEvent.press(registerButton));
  ...
  describe('Password field', () => {
    ...
    it('should show max length error when it have less than 8 characters', async () => {
      const passwordInput = getByTestId('register-password');
  ...
  describe('Confirm Password field', () => {
    it('should show required field error when it is empty', async () => {  
      ...
      const confirmPasswordError = getByTestId('error-register-confirm-password');
  ...
  describe('when form is properly filled', () => {
    it('should show error when trying to register an already taken email', async () => {
      ...
      await waitFor(() => {
        ...
        fireEvent.changeText(getByTestId('register-email'), 'fulano.de.tal@gmail.com');
        ...
        fireEvent.changeText(getByTestId('register-confirm-password'), '12345678');
      });
      await waitFor(() => fireEvent.press(registerButton));
