...
describe('NewProductScreen component', () => {
  describe('when getting categories does not return any error', () => {
    ...
    beforeEach(() => {
      ...
      categorySpy.mockReturnValue(Promise.resolve([{
          id: 1,
          name: 'Roupas'
        }, {
          id: 2,
      ...
      const renderResults = render(
        ...
        >
          ...
          >
            <NativeBaseProvider
              children={<NewProductScreen route={route} />}
            />
          </SafeAreaProvider>
        </AuthContext.Provider>
      );
    ...
    describe('Product name field', () => {
      ...
      it('should show max length field error when it has more than 45 characters', async () => {
        ...
        await waitFor(() => fireEvent.changeText(
          productNameInput, 'Nome de produto muito grande mesmo, que não pode ter mais de 45 caracteres'));
        await waitFor(() => {
          fireEvent.press(createProductButton);
        });
