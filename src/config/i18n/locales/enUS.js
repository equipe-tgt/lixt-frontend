export default {
  ...
  extremelyStrong: 'extremelyStrong',
  signIn: 'Sign Up',
  ...
  noIntervalSelected: 'No date interval was selected',
  selectAnalysisType: 'Select analysis type',
  selectPeriodOfAnalysis: 'Select period of analysis',
  selectDates: 'Select dates',
  selectInterval: 'Select interval',
  selectWeek: 'Select week',
  until: 'until',
  timeStatistics: 'Total expenses',
  listStatistics: 'Expenses per list',
  productBrandStatistics: 'Expenses by product/brand',
  brand: 'Brand',
  product: 'Product',
  categoryStatistics: 'Expenses by category',
  purchaseLocalStatistics: 'Purchase locals',
  MONTHLY: 'Monthly',
  DAILY: 'Daily',
  WEEKLY: 'Weekly',
  clear: 'Clear',
